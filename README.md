...
- `PREVIEW_GATE_LOGIN_PATH=/__preview/login`
- `PREVIEW_GATE_LOGOUT_PATH=/__preview/logout`
...
```elixir
{:ordinary_preview_gate, github: "ordinarycompany/preview_gate", tag: "v0.1.3"}
```
...
You can customize mount path and pipeline:

```elixir
preview_gate_routes(MyAppWeb, path: "/_preview", pipe_through: :browser)
```
